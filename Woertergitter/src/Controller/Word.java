...
public class Word {
     ...
     *
     * @param word the input word as a String
     * @param direction the direction in the Controller.Field saved as enumeration Controller.Direction
     * @param x x-position in Controller.Field
     * @param y y-position in Controller.Field
     * @throws IllegalArgumentException if the {@literal word} does not only contain the 26 letters of the alphabet or if
     * the length of the input-string is not between 5 and 15
     */
     ...
     * @param x x-position in Controller.Field
     * @param y y-position in Controller.Field
     * @throws IllegalArgumentException when x or y are smaller than 0 and thus outside of the Controller.Field
     */
